              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Padding(
                      padding:  EdgeInsets.all(screenWidth*0.03),
                      child: Text("Example: The patient has the symptoms of ….. And has done"
                  ...
                  InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>PcpNextPage()));
                    },
                    child: Container(
                      color: Color(0xfff5f3c6),
                      height: screenHeight*0.06,
                      width: screenWidth,
                      child: Padding(
                        padding:  EdgeInsets.all(screenWidth*0.03),
